...
```pseudocode
Go to the following coordniates one after another [x,y]:
    [100,100]
    [200,100]
    [200,200]
    [100,200]
...
The control panel doesn't move the pen directly. Instead, it manipulates two wave function which in turn control the motors. A simulation of the mechanism helps to explain this:
...
There was some talk about installing a version of Drawing Machine Two on the side of the college building. I abandoned this after learning about the health and safety requirements for an installation like this - It's the kind of job you have to be an actual engineer for.
