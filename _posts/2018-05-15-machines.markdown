...
For a while I considered building a version of Drawing Machine 2 that could hang down the front of the building:

![Machine drawing](/assets/machines/dm2-large.png)

I eventually abandoned this because the health and safety requirements would have been a nightmare.
